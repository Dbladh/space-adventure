...
func _setup_stellar_horizon() -> void:
	...
	var _is_mobile := OS.get_name() == "iOS" or OS.get_name() == "Android" or OS.has_feature("mobile")
	sky_mat.shader = load("res://src/world/cel_sky_mobile.gdshader" if _is_mobile else "res://src/world/cel_sky.gdshader")
